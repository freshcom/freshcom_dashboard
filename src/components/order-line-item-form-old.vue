...
<div id="order-line-item-form" class="component-wrapper">
  <el-form @input.native="updateValue" label-position="top" v-loading="isLoading">
    <div class="m-b-10">
        ...
        <el-tab-pane label="Product" name="productTab">
          <el-row class="m-b-10">
            ...
            <el-col :span="12" class="p-l-10">
              <el-form-item class="full">
                <el-select @change="updateValue" :disabled="!isProductItemSelectable" :placeholder="productItemPlaceholder" v-model="productItem" value-key="id" class="product-item-select">
          ...
          <el-row>
            ...
            <span v-if="price" class="m-r-20">{{price.orderUnit}}</span>

            <span v-if="price && price.estimateByDefault" class="m-r-20">=</span>

            <el-form-item v-if="price && price.estimateByDefault" label="Charge Quantity" class="charge-quantity">
              <el-input v-model="chargeQuantity" @focus="$event.target.select()" type="number"></el-input>
            </el-form-item>

            <span v-if="price && price.estimateByDefault" class="m-r-20">{{price.chargeUnit}}</span>

            <span class="m-r-20">x</span>

            <el-form-item label="Price" class="price">
              <el-select @change="updateValue" v-model="price" value-key="id" placeholder="" :disabled="!price">
