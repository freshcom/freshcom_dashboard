...
<div class="page-wrapper">
  ...
  <div>
    <el-menu :router="true" default-active="/smses" mode="horizontal" class="secondary-nav">
      <el-menu-item :route="{ name: 'ListSms' }" index="/smses">SMS</el-menu-item>
      <el-menu-item :route="{ name: 'ListSmsTemplate' }" index="/sms-templates">Templates</el-menu-item>
    </el-menu>
    <locale-selector @change="searchSms" class="pull-right"></locale-selector>
  </div>
  ...
  <div>
    <el-card class="main-card">
      ...
      <div class="data full" v-loading="isLoading">
        ...
        <el-table v-if="hasSearchResult" @row-click="viewSms" :data="smses">
          <el-table-column prop="to" label="Recipient">
...
export default {
  ...
  methods: {
    ...
    viewSms (email) {
      this.$store.dispatch('pushRoute', { name: 'ShowSms', params: { id: email.id, callbackPath: this.currentRoutePath } })
    }
  }
}
</script>
